...
function _signIn() {
  _signIn = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee6(provider, options, authorizationParams) {
    var _ref6, _ref6$callbackUrl, callbackUrl, _ref6$redirect, redirect, baseUrl, providers, isCredentials, isEmail, isSupportingReturn, signInUrl, _signInUrl, res, data, _data$url, url, error;

    return _regenerator.default.wrap(function _callee6$(_context6) {
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            _ref6 = options !== null && options !== void 0 ? options : {}, _ref6$callbackUrl = _ref6.callbackUrl, callbackUrl = _ref6$callbackUrl === void 0 ? window.location.href : _ref6$callbackUrl, _ref6$redirect = _ref6.redirect, redirect = _ref6$redirect === void 0 ? true : _ref6$redirect;
...
function verifyEmailToken(_x6) {
  return _verifyEmailToken.apply(this, arguments);
}

function _verifyEmailToken() {
  _verifyEmailToken = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee7(_ref3) {
    var email, token, apiRoute, params, url, res, data, error;
      ...
      while (1) {
        switch (_context7.prev = _context7.next) {
          case 0:
            ...
            url = "".concat(apiRoute, "?").concat(params);
            _context7.next = 6;
            return fetch(url, {
              method: "POST",
              headers: {
...
function signOut(_x7) {
  return _signOut.apply(this, arguments);
}

function _signOut() {
  _signOut = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee8(options) {
    var _options$redirect;

    var _ref7, _ref7$callbackUrl, callbackUrl, baseUrl, fetchOptions, res, data, _data$url2, url;

    return _regenerator.default.wrap(function _callee8$(_context8) {
      while (1) {
        switch (_context8.prev = _context8.next) {
          case 0:
            _ref7 = options !== null && options !== void 0 ? options : {}, _ref7$callbackUrl = _ref7.callbackUrl, callbackUrl = _ref7$callbackUrl === void 0 ? window.location.href : _ref7$callbackUrl;
            baseUrl = (0, _utils.apiBaseUrl)(__NEXTAUTH);
            _context8.t0 = {
              "Content-Type": "application/x-www-form-urlencoded"
            };
      ...
      return _regenerator.default.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _ref5 = _args.length > 0 && _args[0] !== undefined ? _args[0] : {}, event = _ref5.event;
              _context.prev = 1;
